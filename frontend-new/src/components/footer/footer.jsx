    ...
    <footer className="footer footer-center bg-base-200 text-base-content p-10 rounded-xl mt-10">
      <nav className="mb-4">
        <div className="grid grid-flow-col gap-6">
          {/* Email */}
          <a
            href="mailto:teozhengyang01@gmail.com"
            aria-label="Email"
            className="hover:bg-[#6699CC]/10 p-2 rounded-full transition"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 fill-[#4A5568]" viewBox="0 0 24 24">
